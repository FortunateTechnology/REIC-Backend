...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#getEditData', function(e) {
            ...
            $('.alert-success').hide();
            $('#name').val('Package1');
            $('#thead').html('<i class="fas fa-list-ol"></i> แก้ไข Package');
            //$("#duallistbox").val('Dash Board1');
            //$('#duallistbox').bootstrapDualListbox('refresh');
            //$("#duallistbox").val('Dash Board4');
            $('#duallistbox option')[0].selected = true;
            $('#duallistbox option')[4].selected = true;
            $('#duallistbox').bootstrapDualListbox('refresh');
            $('#CreateModal').modal('show');
/*
            id = $(this).data('id');
