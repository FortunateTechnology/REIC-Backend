...
@section('style')
    @include('reporttoppackage.style')
@endsection
                ...
                <div class="col-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa-solid fa-magnifying-glass"></i> รายงานสถิติการเลือกใช้ Package</h3>
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control float-right" id="reservationtime" style="width: 210px">
                                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa-solid fa-print"></i> รายงานสถิติการเลือกใช้ Package
                            </h3>
                            <div class="card-tools">
...
@section('script')
    @include('reporttoppackage.script')
