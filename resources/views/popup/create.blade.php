    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h4 class="modal-title"><div id="thead"><i class="fas fa-list-ol"></i> เพิ่ม Popup</div></h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong><i class="fas fa-list-ol"></i> Popup:</strong>
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            <strong><i class="fas fa-list-ol"></i> วันที่เริ่ม-สิ้นสุด:</strong>
                            <input type="text" class="form-control float-right" id="reservationtime" style="width: 210px" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
